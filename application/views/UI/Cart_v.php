    ...
    <div class="page-header breadcrumb-wrap">
        <div class="container">
            <div class="breadcrumb">
                <a href="<?php echo base_url('home')?>" rel="nofollow">Home</a>
                <span></span> <a href="<?php echo base_url('shop')?>">Shop</a>
                <span></span> Your Cart
            </div>
        </div>
    </div>
                                    ...
                                    <input type="hidden" id="txt_stock_<?php echo $item['product_id'];?>" value="<?php echo $stock;?>">
                                        ...
                                        <td class="product-des product-name text-start">
                                            <h5 class="product-name"><a
                                                    href="<?php echo base_url('product-detail/').$short_code;?>"><?php echo $item['product_name'];?></a>
                                            </h5>
